  ...
  attributes: {
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        ...
        'sections.hero-intro',
        'sections.gallery',
        'sections.image-repeater',
        'sections.content',
        'sections.pricing',
        'sections.pricing-tiers',
        'sections.faq',
        'sections.three-column-img-content',
        'sections.expertise-content',
        'sections.equal-grid',
        'sections.unsequenced-grid',
        'sections.cta',
        'sections.slider',
        'sections.image',
        'sections.contact',
        'sections.two-column-img-content',
        'sections.image-text',
        'sections.image-text-highlighted',
        'sections.two-column-image',
        'sections.text-highlighted',
        'sections.thank-you',
        'sections.quote',
        'sections.about',
      ]
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author: Schema.Attribute.String & Schema.Attribute.DefaultTo<'SEO Admin'>;
    category: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Logo Design'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    facebookIcon: Schema.Attribute.Media<'images'>;
    facebookUrl: Schema.Attribute.String;
    footerDividerImage: Schema.Attribute.Media<'images'>;
    helpLink1Text: Schema.Attribute.String;
    helpLink1Url: Schema.Attribute.String;
    helpLink2Text: Schema.Attribute.String;
    helpLink2Url: Schema.Attribute.String;
    helpLink3Text: Schema.Attribute.String;
    helpLink3Url: Schema.Attribute.String;
    helpLink4Text: Schema.Attribute.String;
    helpLink4Url: Schema.Attribute.String;
    linkedinIcon: Schema.Attribute.Media<'images'>;
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    nav_links: Schema.Attribute.Component<'shared.nav-link', true>;
    publishedAt: Schema.Attribute.DateTime;
    siteName: Schema.Attribute.String & Schema.Attribute.Required;
    skypeIcon: Schema.Attribute.Media<'images'>;
    skypeUrl: Schema.Attribute.String;
    twitterIcon: Schema.Attribute.Media<'images'>;
...
export interface ApiPortfolioPagePortfolioPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Portfolio Page'>;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.DynamicZone<
      [
        'sections.hero',
...
export interface ApiPricingPagePricingPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Pricing Page'>;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.DynamicZone<
      [
        'sections.hero',
...
export interface ApiProcessPageProcessPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Process Page'>;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.DynamicZone<
      [
        'sections.hero',
